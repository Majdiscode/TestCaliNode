...
let pullSkills: [SkillNode] = [
    SkillNode(id: "deadHang", label: "🪢", fullLabel: "Dead Hang (10s)", requires: [], confirmPrompt: "Can you Dead Hang for 10 seconds?", unlocked: false),
    ...
    SkillNode(id: "isoHold", label: "🧍", fullLabel: "Isometric Hold (20s)", requires: ["pullUp"], confirmPrompt: "Can you hold an Isometric Pull-Up for 20 seconds?", unlocked: false)
]
